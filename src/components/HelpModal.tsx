      ...
      <div className="flex max-h-[85vh] w-full max-w-md flex-col overflow-hidden rounded-t-3xl bg-ivory shadow-2xl sm:rounded-3xl">
        ...
        <div className="flex-1 space-y-4 overflow-y-auto px-5 py-5">
          ...
          <Section title="🏃 움직임 추천 받는 법">
            트레이에서 간식을 <strong className="font-bold text-teal">하나라도 선택하면</strong> 화면
            아래에 <strong className="font-bold text-teal">“움직임으로 바꾸기”</strong> 버튼이 나타나요.
            눌러서 시간·장소·강도를 고르면 AI가 지금 상황에 맞는 움직임 3가지를 추천해줘요.
          </Section>
        </div>

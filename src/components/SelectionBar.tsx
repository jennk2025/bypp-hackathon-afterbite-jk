...
export function SelectionBar({ selectedCount, totalCalories, onConvert }: SelectionBarProps) {
  ...
  return (
    ...
    >
      <div className="flex w-full max-w-md items-center justify-between gap-4 rounded-2xl border border-navy/10 bg-ivory-card/95 px-5 py-3.5 shadow-[0_8px_30px_rgba(74,55,40,0.15)] backdrop-blur sm:max-w-xl lg:max-w-2xl">
        <div>
